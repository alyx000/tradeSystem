...
新增一周临时监控：`dajin-heavy-breakout-35-95-20260912-18`，新浪实时大金重工 `002487.SZ >35.95元`；有效期 2026-09-12～09-18（首尾包含，7自然日）。交易日盘中每3分钟检查，等于不触发；首次已突破提醒、同日持续命中去重、回落到阈值或下方后再次突破提醒。9月19日起停止该规则取数和推送，复用现有引擎、状态与钉钉渠道。
