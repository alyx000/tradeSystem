...
科翔股份7个交易日临时监控：`kexiang-below-108-30-20260922-1008`，新浪实时 `300903.SZ <108.30元`（严格小于，等于不触发）。9月21日收盘后新增，从下一交易日计满7天：有效期2026-09-22～10-08首尾包含（9月22、23、24、28、29、30日和10月8日），周末、中秋及国庆休市不计入，10月9日起停止该规则取数与推送。沿用盘中每3分钟、首次已跌破提醒、同日持续命中去重、回升至阈值或上方后再次跌破提醒，复用日历/新鲜度守卫与钉钉；其他监控及历史状态不变。
