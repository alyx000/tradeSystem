...
新增临时规则 `fangsheng-reach-11-11-20260903-16`：新浪实时 `603998.SH` 方盛制药最新价格 `>=11.11元`，有效期为 2026-09-03 至 2026-09-16（首尾包含，共 14 个自然日，交易日盘中执行）。等于即命中；首次观察已在线上会提醒，同日持续命中去重，回落到线下后再触达可重推；9月17日起不再抓取或推送该规则。其余规则、交易日历、新鲜度与独立状态边界不变。
