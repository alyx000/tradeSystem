...
福龙马临时突破监控：`fulongma-breakout-14-15-20260916-24`，新浪实时 `603686.SH >14.15元`（严格大于，等于不触发）；有效期2026-09-16～09-24首尾包含，共7个开放交易日（16、17、18、21、22、23、24日），9月25日起停止。沿用盘中每3分钟、首次已突破提醒、同日持续命中去重、回落至阈值或下方后再次突破提醒；复用原有日历/新鲜度守卫与钉钉，其他监控不变。

有研硅临时突破监控：`youyan-silicon-breakout-46-14-20260916-30`，新浪实时 `688432.SH >46.14元`（严格大于，等于不触发）；有效期2026-09-16～09-30首尾包含，共10个开放交易日（16、17、18、21、22、23、24、28、29、30日），中秋休市不计入，10月1日起停止。沿用盘中每3分钟、首次已突破提醒、同日持续命中去重、回落至阈值或下方后再次突破提醒；与福龙马及其他规则独立，不改状态机与推送通道。
