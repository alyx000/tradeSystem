...
- **双窗对照 20/60**：原始日涨跌幅 Pearson（联动）+ **剔除上证后的残差超额相关**（真跷跷板，逆向以此为准）+ 板块对 4 指数（上证/创业板/沪深300/科创50）的相关与 β。两窗都显著=稳定关系，仅短窗=近期偶然。
- **今日联动快照**：日报顶部按目标日当日涨跌幅分「🔴 齐涨 / 🟢 齐跌」（事实层，A股红涨绿跌），看今天哪些板块联袂涨跌，与窗口结构联动互相印证（如某日电力独涨 vs 芯片齐跌，印证结构反向榜的跷跷板）。
