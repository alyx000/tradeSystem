...
def register_subparser(subparsers: argparse._SubParsersAction) -> None:
    parser = subparsers.add_parser(
        ...
        description=(
            ...
            "2026年9月16日至24日（7个交易日）另监控福龙马严格突破14.15元。"
            "2026年9月16日至30日（10个交易日）另监控有研硅严格突破46.14元。"
        ),
    )
    ...
    check = commands.add_parser(
        ...
        description=(
            ...
            "2026年9月16日至24日福龙马严格高于14.15元时推送；等于不触发，首次已突破提醒。"
            "2026年9月16日至30日有研硅严格高于46.14元时推送；等于不触发，首次已突破提醒。"
        ),
    )
