...
PORTFOLIO_COMMANDS = [
    ...
    ["db", "holdings-add", "--code", "300750", "--name", "N",
     ...
     "--entry-date", "2026-07-01", "--input-by", "cursor"],
    ["db", "holdings-add", "--code", "300750", "--name", "N",
     "--entry-reason", "主线龙头启动", "--note", "观察量能", "--input-by", "manual"],
...
ARCHITECTURE_COMMANDS = [
    ...
    ["volume-record", "daily", "--date", "2026-09-18", "--input-by", "pytest"],
    ["volume-record", "daily", "--date", "2026-09-18", "--metric", "amount", "--dry-run", "--input-by", "pytest"],
    ["volume-record", "push", "--date", "2026-09-18", "--input-by", "pytest"],
    ["schedule"],
    ...
    ["volume-watch", "daily", "--no-push"],
    ["volume-watch", "daily", "--refetch"],
    ["volume-watch", "daily", "--date", "2026-05-29", "--refetch"],
    ["volume-watch", "daily", "--date", "2026-07-07", "--no-push", "--refetch"],
    ["volume-watch", "trend"],
    ...
    ["new-high", "daily", "--push"],
    ["new-high", "daily", "--json", "--top-n", "10"],
    ["new-high", "trend", "--date", "2026-07-08", "--days", "30"],
    ["new-high", "trend", "--date", "2026-07-08", "--days", "30", "--json"],
    ["new-high", "backfill", "--start-date", "2021-07-08", "--end-date", "2026-07-08"],
    ["new-high", "backfill", "--dry-run"],
    ...
    ["research-digest", "trend"],
    ["research-digest", "trend", "--days", "30", "--recent-n", "5"],
    ["research-digest", "trend", "--backfill", "30"],
    ["research-digest", "trend", "--json", "--top", "8"],
    ["research-digest", "trend", "--days", "40", "--recent-n", "5", "--top", "10", "--backfill", "20", "--json"],
    ...
    ["trend-leader", "daily", "--date", "2026-06-12", "--main-line", "l2+concept",
     "--top-concepts", "8", "--no-push"],
    ["trend-leader", "pool"],
    ["trend-leader", "pool", "--status", "active"],
    ["trend-leader", "pool", "--status", "exited", "--json"],
    # monthly-pattern（月线模式观察池:完成月技术确认 + 公告日 as-of 财务校验）
    ["monthly-pattern", "daily", "--input-by", "pytest"],
    ["monthly-pattern", "daily", "--input-by", "pytest", "--date", "2026-06-30"],
    ["monthly-pattern", "daily", "--input-by", "pytest", "--dry-run"],
    ["monthly-pattern", "daily", "--input-by", "pytest", "--no-push"],
    ["monthly-pattern", "daily", "--input-by", "pytest", "--months", "48", "--no-financial"],
    ["monthly-pattern", "pool"],
    ["monthly-pattern", "pool", "--status", "active"],
    ["monthly-pattern", "pool", "--strategy", "theme_monthly_attack", "--json"],
    ["monthly-pattern", "monitor"],
    ["monthly-pattern", "monitor", "--date", "2026-06-30", "--json"],
    ["monthly-pattern", "monitor", "--months", "48", "--max-seeds", "20",
     "--save-report"],
    ["monthly-pattern", "monitor-daily"],
    ["monthly-pattern", "monitor-daily", "--date", "2026-06-30",
     "--months", "48", "--no-push", "--json"],
    ["monthly-pattern", "monitor-daily", "--dry-run"],
    ["monthly-pattern", "backfill", "--input-by", "pytest",
     "--start-month", "2024-01", "--end-month", "2026-06"],
    ["monthly-pattern", "backfill", "--start-month", "2024-01", "--end-month", "2026-06",
     "--input-by", "pytest", "--dry-run", "--no-financial"],
    ["monthly-pattern", "facts-backfill", "--date", "2026-06-30",
     "--input-by", "pytest", "--dry-run"],
    ["monthly-pattern", "facts-backfill", "--date", "2026-06-30",
     "--input-by", "pytest", "--dry-run", "--max-stocks", "3"],
    ["monthly-pattern", "facts-backfill", "--date", "2026-06-30",
     "--input-by", "pytest", "--expect-receipt-hash",
